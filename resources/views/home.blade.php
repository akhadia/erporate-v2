...
@section('content')
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
          ...
          <div class="icon">
            ...
            <a href="{{url('transaksi/pesanan/index2/baru')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
          ...
          <a href="{{url('transaksi/pesanan/index2/selesai')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
